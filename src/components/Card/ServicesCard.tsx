...
const ServiceCard = ({ name, description, image, slug, lang }: ServiceCardProps) => {
  return (
    <div className="group bg-white rounded-[40px] p-5 h-[calc(100%-30px)] mb-[30px] transition-all duration-300">
      <div className="p-5">
        {/* Header with Arrow */}
        <div className="flex items-center justify-between border-b border-[#e5e7eb] pb-[25px] mb-[25px]">
          <h2 className="text-[26px] font-bold text-[#1e1e2f] w-full max-w-[200px] capitalize leading-tight">
            {name}
          </h2>
          <Link
